...
Power Ground and the TX can simply be taken from the receiver **roll** connector.For the RX a thin wire must be soldered to the (free)pin 30 of the ATmega chip. 
